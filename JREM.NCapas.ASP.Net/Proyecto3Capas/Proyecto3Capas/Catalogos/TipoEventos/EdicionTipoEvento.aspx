<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EdicionTipoEvento.aspx.cs" Inherits="Proyecto3Capas.Catalogos.TipoEventos.EdicionTipoEvento" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <br /><br /><br />
                <h3>Editar Tipo de Evento: <asp:Label ID="lblIdTipoEvento" runat="server" Text=""></asp:Label></h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12" style="margin-bottom:30px">
                        <div style="position:absolute;top:0;left:0">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="txtPrecio" CssClass="text-danger" runat="server" ErrorMessage="Precio requerido"></asp:RequiredFieldValidator>
                        </div>
                        <div style="position:absolute;top:0;left:0">
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="txtPrecio" ValidationExpression="^\s*(?=.*[1-9])\d*(?:\.\d{1,2})?\s*$"  CssClass="text-danger" runat="server" ErrorMessage="Precio debe ser numérico"></asp:RegularExpressionValidator>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtDescripcion" CssClass="form-control" runat="server"></asp:TextBox>
                      <div class="col-md-12" style="margin-bottom:30px">
                        <div style="position:absolute;top:0;left:0">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="txtDescripcion" CssClass="text-danger" runat="server" ErrorMessage="Descripcion requerida"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtClave" CssClass="form-control" runat="server"></asp:TextBox>
                      <div class="col-md-12" style="margin-bottom:30px">
                        <div style="position:absolute;top:0;left:0">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="txtClave" CssClass="text-danger" runat="server" ErrorMessage="Clave requerida"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                </div>
