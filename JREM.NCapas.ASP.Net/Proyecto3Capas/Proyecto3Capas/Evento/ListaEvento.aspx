<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListaEvento.aspx.cs" Inherits="Proyecto3Capas.Evento.ListaEvento" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div class="section-gallery p-t-118 p-b-100">
		<div class="wrap-label-gallery filter-tope-group size27 flex-w flex-sb-m m-l-r-auto flex-col-c-sm p-l-15 p-r-15 m-b-60">
			<h3 class="label-gallery txt26 trans-0-4 is-actived" data-filter="*">
				Calidad
			</h3>

			<h3 class="label-gallery txt26 trans-0-4" data-filter=".interior">
				Elegancia
			</h3>

			<h3 class="label-gallery txt26 trans-0-4" data-filter=".food">
				Confortable
			</h3>

			<h3 class="label-gallery txt26 trans-0-4" data-filter=".events">
				Eventos
			</h3>

			<h3 class="label-gallery txt26 trans-0-4" data-filter=".guests">
				Clientes Vip
			</h3>
		</div>
